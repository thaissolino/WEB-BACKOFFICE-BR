          ...
          <tbody>
            {lucrosPaginados.length > 0 ? (
              lucrosPaginados.map((lucro) => {
                ...
                return (
                  <tr key={lucro.id} className="hover:bg-gray-50">
                    <td className="py-2 px-4 border text-center">{formatDate(lucro.data)}</td>
                    <td className="py-2 px-4 border text-center">
                      {operacao ? operacao.local.toUpperCase() : "N/A"}
                    </td>
                    <td className="py-2 px-4 border text-center">
                      {operacao ? formatCurrency(operacao.valor) : "-"}
                    </td>
                    <td className="py-2 px-4 border text-center text-green-600 font-medium">
