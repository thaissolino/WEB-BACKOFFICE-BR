...
const allTabs = [
  ...
  { id: "media-dolar", icon: <DollarSign className="mr-2" size={16} />, label: "Média Dólar", permissionKey: "MEDIA_DOLAR" },
  ...
  { id: "caixas-brl", icon: <Boxes className="mr-2" size={16} />, label: "Caixas BR", permissionKey: "CAIXAS_BR_PERMITIDOS" },
];
